...
if __name__ == '__main__':
    ...
    for i in range(1, dataSize + 1):
        test_dirs.append("../data/DANCE_" + danceType + "_" + str(i))
        if one_sample_train:
            train_dirs.append("../data/DANCE_" + danceType + "_1")
        else:
            if i <= trainSize:
                train_dirs.append("../data/DANCE_" + danceType + "_" + str(i))
            else:
                valid_dirs.append("../data/DANCE_" + danceType + "_" + str(i))
